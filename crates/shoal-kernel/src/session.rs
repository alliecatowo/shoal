//! Session/attachment composition and the `session.attach` handlers. The
//! local health, transcript, output-undo, and stream-cursor behavior lives in
//! [`state`] so authentication/composition does not grow into a god module.
use super::*;
