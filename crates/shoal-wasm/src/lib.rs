...
use abi::shoal::plugin::types::{
    Declaration, ErrorKind, GuestError, GuestValue, MethodDeclaration, ValueKind,
};
...
impl PluginValue {
    fn into_guest(self, max_bytes: usize) -> Result<GuestValue, PluginError> {
    ...
    fn from_guest(value: GuestValue, max_bytes: usize) -> Result<Self, PluginError> {
...
impl Manifest {
    ...
    fn validate_shape(&self, path: &Path) -> Result<(), PluginError> {
