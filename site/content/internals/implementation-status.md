...
4. auth has no live token-administration RPC even though file changes are observed immediately;
5. kernel quotas and separate evaluator budgets bound retained sessions, 64 native workers per
...
6. Windows remains a separate architecture project.
