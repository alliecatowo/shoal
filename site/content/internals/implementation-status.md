...
| evaluator and structured values | Implemented | evaluator tests and 1,358 corpus cases | dynamic/opaque values retain tag-level rather than static element schemas |
...
**1,358 cases across 79 suites**. An exact-toolchain run on 2026-07-18 observed **1,354 passed, 0
